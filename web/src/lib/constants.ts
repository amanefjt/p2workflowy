...
// Book Mode Prompts
export const BOOK_STRUCTURE_PROMPT = (prompts as any).BOOK_STRUCTURE_PROMPT;
export const BOOK_CHAPTER_SUMMARY_PROMPT = (prompts as any).BOOK_CHAPTER_SUMMARY_PROMPT;
export const BOOK_STRUCTURING_PROMPT = (prompts as any).BOOK_STRUCTURING_PROMPT;
export const BOOK_TRANSLATION_PROMPT = (prompts as any).BOOK_TRANSLATION_PROMPT;
