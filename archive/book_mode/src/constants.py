...
MAX_STRUCTURING_CHUNK_SIZE = _prompts.get("MAX_STRUCTURING_CHUNK_SIZE", 40000)
...
# 書籍モード用定数
BOOK_TOC_MAPPING_PROMPT = _prompts.get("BOOK_TOC_MAPPING_PROMPT", "")
BOOK_CHAPTER_CONCURRENCY = _prompts.get("BOOK_CHAPTER_CONCURRENCY", 3)