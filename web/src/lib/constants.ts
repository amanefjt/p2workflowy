...
export const BOOK_CHAPTER_SUMMARY_PROMPT = prompts.BOOK_CHAPTER_SUMMARY_PROMPT;
...
export const BOOK_TRANSLATION_PROMPT_SIMPLE = prompts.BOOK_TRANSLATION_PROMPT_SIMPLE;
export const TOC_ANALYSIS_PROMPT = prompts.BOOK_STRUCTURE_PROMPT;
