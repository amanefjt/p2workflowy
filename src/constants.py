...
# 書籍モード用プロンプト
BOOK_STRUCTURE_PROMPT = _prompts.get("BOOK_STRUCTURE_PROMPT", "")
BOOK_SUMMARY_PROMPT = _prompts.get("BOOK_SUMMARY_PROMPT", "")
BOOK_CHAPTER_SUMMARY_PROMPT = _prompts.get("BOOK_CHAPTER_SUMMARY_PROMPT", "")
BOOK_STRUCTURING_PROMPT = _prompts.get("BOOK_STRUCTURING_PROMPT", "")
BOOK_TRANSLATION_PROMPT = _prompts.get("BOOK_TRANSLATION_PROMPT", "")
BOOK_TRANSLATION_PROMPT_SIMPLE = _prompts.get("BOOK_TRANSLATION_PROMPT_SIMPLE", "")
PAPER_TRANSLATION_PROMPT_SIMPLE = _prompts.get("PAPER_TRANSLATION_PROMPT_SIMPLE", "")