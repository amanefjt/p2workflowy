...
# 同じかは未検証だが、保守的な値のためそのまま流用する。なお 2026-09-10〜09-15 の間
# 一時的に gemini-3.8-flash へ切替えていたが、無料枠でこの規模の単発リクエストが
# 503 で通らないことが判明し gemini-3.6-flash へ差し戻した（troubleshooting_log.md I-45）。
