...
# Book Mode Prompts
BOOK_GLOBAL_RESUME_PROMPT = _prompts.get("BOOK_GLOBAL_RESUME_PROMPT", "")
BOOK_TOC_EXTRACTION_PROMPT = _prompts.get("BOOK_TOC_EXTRACTION_PROMPT", "")
BOOK_CHAPTER_RESUME_PROMPT = _prompts.get("BOOK_CHAPTER_RESUME_PROMPT", "")
BOOK_CHAPTER_STRUCTURING_PROMPT = _prompts.get("BOOK_CHAPTER_STRUCTURING_PROMPT", "")
BOOK_SECTION_TOC_EXTRACTION_PROMPT = _prompts.get("BOOK_SECTION_TOC_EXTRACTION_PROMPT", "")
